 ...
 * {@link MedlineCitation} objects. It uses the classes generated by jaxb from
 * the Medline DTD to implement an XML parser for files distributed by NLM when
 * leasing the Medline database.
 *
 */
public class MedlineXmlParser implements Iterator<MedlineCitation> {

	private Class<MedlineCitation> iteratedClass = MedlineCitation.class;
	...
	private MedlineCitation nextCitation = null;
	...
	public MedlineCitation next() {
		...
		MedlineCitation citation = nextCitation;
		nextCitation = null;
		return citation;
	}
